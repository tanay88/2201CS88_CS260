  ...
  upload.fields([
    ...
    let page_8 = {
      ...
      misc_path: req.files["miscCertificate"]
        ...
        : null,
      sign_path: req.files["signature"] ? req.files["signature"][0].path : null,
      research_path: req.files["research"]
        ? req.files["research"][0].path
        : null,
...
app.get("/formpages/print", (req, res) => {
  const userEmail = req.session.currUser.email;
  db.query(
                    ...
                    (err, educationaldetails) => {
                      ...
                      db.query(
                        ...
                        (err, edu_additionaldetails) => {
                          if (err) {
                            console.error("Error retrieving upload details:", err);
                            return res.status(500).send("Internal Server Error6");
                          }
                          db.query(
                            "SELECT * FROM datapage WHERE email = ?",
                            [userEmail],
                            (err, publications) => {
                              if (err) {
                                console.error("Error retrieving upload details:", err);
                                return res.status(500).send("Internal Server Error7");
                              }
                              db.query(
                                ...
                                (err, present) => {
                                  if (err) {
                                    console.error("Error retrieving upload details:", err);
                                    return res.status(500).send("Internal Server Error8");
                                  }
                                  db.query(
                                    ...
                                    (err, employhist) => {
                                      if (err) {
                                        console.error("Error retrieving upload details:", err);
                                        return res.status(500).send("Internal Server Error9");
                                      }
                                      db.query(
                                        ...
                                        (err, teaching) => {
                                          if (err) {
                                            console.error("Error retrieving upload details:", err);
                                            return res.status(500).send("Internal Server Error10");
                                          }
                                          db.query(
                                            ...
                                            (err, research) => {
                                              if (err) {
                                                console.error("Error retrieving upload details:", err);
                                                return res.status(500).send("Internal Server Error11");
                                              }
                                              db.query(
                                                ...
                                                (err, Industrial) => {
                                                  if (err) {
                                                    console.error("Error retrieving upload details:", err);
                                                    return res.status(500).send("Internal Server Error12");
                                                  }
                                                  db.query(
                                                    ...
                                                    (err, aosaor) => {
                                                      if (err) {
                                                        console.error("Error retrieving upload details:", err);
                                                        return res.status(500).send("Internal Server Error13");
                                                      }
                                                      db.query(
                                                        ...
                                                        (err, publications) => {
                                                          if (err) {
                                                            console.error("Error retrieving upload details:", err);
                                                            return res.status(500).send("Internal Server Error14");
                                                          }
                                                          ...
                                                          db.query(
                                                            ...
                                                            (err, top10publications) => {
                                                              if (err) {
                                                                console.error("Error retrieving upload details:", err);
                                                                return res.status(500).send("Internal Server Error15");
                                                              }
                                                              ...
                                                              db.query(
                                                                ...
                                                                (err, patents) => {
                                                                  if (err) {
                                                                    console.error("Error retrieving upload details:", err);
                                                                    return res.status(500).send("Internal Server Error16");
                                                                  }
                                                                  ...
                                                                  db.query(
                                                                    ...
                                                                    (err, books) => {
                                                                      if (err) {
                                                                        console.error("Error retrieving upload details:", err);
                                                                        return res.status(500).send("Internal Server Error17");
                                                                      }
                                                                      ...
                                                                      db.query(
                                                                        ...
                                                                        (err, book_chapters) => {
                                                                          if (err) {
                                                                            console.error("Error retrieving upload details:", err);
                                                                            return res.status(500).send("Internal Server Error18");
                                                                          }
                                                                          db.query(
                                                                            ...
                                                                            (err, googlelink) => {
                                                                              if (err) {
                                                                                console.error("Error retrieving upload details:", err);
                                                                                return res.status(500).send("Internal Server Error19");
                                                                              }
                                                                              db.query(
                                                                                ...
                                                                                (err, membership) => {
                                                                                  if (err) {
                                                                                    console.error("Error retrieving upload details:", err);
                                                                                    return res.status(500).send("Internal Server Error20");
                                                                                  }
                                                                                  db.query(
                                                                                    ...
                                                                                    (err, training) => {
                                                                                      if (err) {
                                                                                        console.error("Error retrieving upload details:", err);
                                                                                        return res.status(500).send("Internal Server Error21");
                                                                                      }
                                                                                      db.query(
                                                                                        ...
                                                                                        (err, awards) => {
                                                                                          if (err) {
                                                                                            console.error("Error retrieving upload details:", err);
                                                                                            return res.status(500).send("Internal Server Error22");
                                                                                          }
                                                                                          db.query(
                                                                                            ...
                                                                                            (err, phd_thesis) => {
                                                                                              if (err) {
                                                                                                console.error("Error retrieving upload details:", err);
                                                                                                return res.status(500).send("Internal Server Error23");
                                                                                              }
                                                                                              db.query(
                                                                                                ...
                                                                                                (err, pg_thesis) => {
                                                                                                  if (err) {
                                                                                                    console.error("Error retrieving upload details:", err);
                                                                                                    return res.status(500).send("Internal Server Error24");
                                                                                                  }
                                                                                                  db.query(
                                                                                                    ...
                                                                                                    (err, ug_thesis) => {
                                                                                                      if (err) {
                                                                                                        console.error("Error retrieving upload details:", err);
                                                                                                        return res.status(500).send("Internal Server Error25");
                                                                                                      }
                                                                                                      db.query(
                                                                                                        ...
                                                                                                        (err, sponsoredprojects) => {
                                                                                                          if (err) {
                                                                                                            console.error("Error retrieving upload details:", err);
                                                                                                            return res.status(500).send("Internal Server Error26");
                                                                                                          }
                                                                                                          db.query(
                                                                                                            ...
                                                                                                            (err, consultancyprojects) => {
                                                                                                              if (err) {
                                                                                                                console.error("Error retrieving upload details:", err);
                                                                                                                return res.status(500).send("Internal Server Error27");
                                                                                                              ...
                                                                                                              db.query(
                                                                                                                ...
                                                                                                                (err, datapage) => {
                                                                                                                  if (err) {
                                                                                                                    console.error("Error retrieving upload details:", err);
                                                                                                                    return res.status(500).send("Internal Server Error28");
                                                                                                                  ...
                                                                                                                  db.query(
                                                                                                                    ...
                                                                                                                    (err, page_7) => {
                                                                                                                      if (err) {
                                                                                                                        console.error("Error retrieving upload details:", err);
                                                                                                                        return res.status(500).send("Internal Server Error29");
                                                                                                                      ...
                                                                                                                      db.query(
                                                                                                                        ...
                                                                                                                        (err, applicationdetails) => {
                                                                                                                          if (err) {
                                                                                                                            console.error("Error retrieving upload details:", err);
                                                                                                                            return res.status(500).send("Internal Server Error30");
